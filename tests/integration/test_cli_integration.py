...
class TestStartCommandIntegration:
    ...
    def test_start_loads_credentials_successfully(
        ...
        with patch("claude_task_master.cli_commands.workflow_helpers.AgentWrapper"):
            with patch("claude_task_master.cli_commands.workflow_helpers.Planner") as mock_planner:
...
class TestResumeCommandIntegration:
    ...
    def test_resume_loads_credentials_successfully(
        ...
        with patch("claude_task_master.cli_commands.workflow_helpers.AgentWrapper"):
            with patch("claude_task_master.cli_commands.workflow_helpers.Planner"):
                with patch(
                    "claude_task_master.cli_commands.workflow_helpers.WorkLoopOrchestrator"
                ) as mock_orch:
