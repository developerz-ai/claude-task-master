...
_FORWARDING_SPECS: tuple[ForwardingSpec, ...] = (
    ...
    ForwardingSpec(
        ...
        "        the lead sizes its own team and zero workers is a valid answer.\n"
        "    state_dir: Optional custom state directory path.\n\n"
        "Returns:\n"
    ...
    ForwardingSpec(
        ...
        "    parallel: Whether a work session may split its one task across\n"
        "        'hive-worker' subagents with disjoint write sets.\n"
        "    state_dir: Optional custom state directory path.\n\n"
        "Returns:\n"
