...
Async loop utilities live in :mod:`.agent_async_utils`.
Code-style / release-guide generation lives in :mod:`.agent_phase_generation`.
"""
...
from . import console
from .agent_async_utils import (
    _SHUTDOWN_POLL_SEC,  # noqa: F401 — re-exported for test patching
    _TRAILING_PLANNING_COMPLETE_RE,  # noqa: F401 — re-exported for test patching
    _drive_coroutine_on_new_loop,  # noqa: F401 — re-exported for test patching
...
class AgentPhaseExecutor(_AgentPhaseGenerationMixin):
