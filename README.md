...
> **Note:** Opus 4.7 and Sonnet 4.6 support a 1M token context window in beta (**tier 4+** API access required). If you have tier 4+ access, you can increase the context windows:
> ```json
> "context_windows": {
>   "opus": 1000000,
>   "sonnet": 1000000,
