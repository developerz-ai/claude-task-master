---
description: End-to-end feature workflow for claude-task-master — understand, explore, build (SRP modules, parallel worktree agents), verify, PR, merge, release. Tracks in GitHub issues. Reads intent from the prompt.
